          ...
          <view class="money-text">
            <template v-if="$store.state.appInfoStore.userInfo.userBalance">
              ...
              <u-count-to class="text" :decimals="2" :start-val="0"
                :end-val="$store.state.appInfoStore.userInfo.userBalance" @end="isEnd1 = true" v-else></u-count-to>
            </template>
        ...
        <view class="money-box">
          <view class="money-text">
            <template v-if="$store.state.appInfoStore.userInfo.gameLockBalance">
              ...
              <u-count-to class="text" :decimals="2" :start-val="0"
                :end-val="$store.state.appInfoStore.userInfo.gameLockBalance" @end="isEnd2 = true" v-else></u-count-to>
            </template>
          </view>
          <view class="money-desc">
            未结金额（元）
