<template>
    <view class="activity" :style="{ marginTop: safeHeight }">
        ...
        <view class="list-row">
            ...
            <z-paging :style="'height: calc(var(--vh) - 96rpx - 160rpx);'" class="paging" ref="paging" v-model="lists"
                ...
                :refresher-default-img="'/static/img/liuhe/load.gif'" :refresher-pulling-img="'/static/img/liuhe/load.gif'"
